...
plotGG(gbcd$`CG16779 female gonad tj vs female gonad tj`, x = 0.5, y=3, width = 3.5,height = 2.25)
plotText(gbcd_p_lookup$`CG16779 female gonad tj vs female gonad tj`, x=2.75, y=3.5,fontsize = 7)
plotText("C", x = .5, y=3)


plotGG(gbcd$`pan female gonad nos vs female gonad nos`, x = 4.5, y=3, width = 3.5,height = 2.25)
plotText(gbcd_p_lookup$`pan female gonad nos vs female gonad nos`, x=6.75, y=3.5,fontsize = 7)
